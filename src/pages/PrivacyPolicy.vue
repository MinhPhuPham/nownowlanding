    ...
    <section class="view-contain container--fluid user-layout-text">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            electronic device, named TapNow
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Sango technologies, Inc., 1-19-7 Kunuta, Setagaya-ku, Tokyo
            1570073.
          </p>
        ...
        <li>
          ...
          <p>
            ...
            <a
              ...
              rel="external nofollow noopener"
              target="_blank"
              >https://www.appsflyer.com/legal/services-privacy-policy/</a
            >
          </p>
        </li>
      </ul>
        ...
        <li>
          <p>
            <strong
              ...
              U.S.C. Section 1232g, 34 C.F.R. Part 99)).</strong
            >
          </p>
          <p>
      ...
      <ul>
        ...
        <li>
          ...
          You have the right to direct Us to not sell Your personal information. To submit an opt-out request please
          contact Us.
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@sango-tech.com</li>
      </ul>
      <p>
