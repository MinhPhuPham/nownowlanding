  ...
  <Layout :title="$t('termOfService.title')" :content="$t('termOfService.description')">
    <section class="view-contain container--fluid user-layout-text">
      ...
      <p>
        ...
        submit Your notice in writing to the attention of our copyright agent via email at support@sango-tech.com and
      ...
      <p>
        You can contact our copyright agent via email at support@sango-tech.com. Upon receipt of a notification, the
